...
#SBATCH --job-name=extract-caption-mpi
...
. /projects/pata4332/venv/sci-clip/bin/activate
mpirun -n $SLURM_NTASKS python3 extract_image_caption.py -i /pl/active/acuna/oa_package -o /pl/active/acuna/image-caption-pair/stage00_image_caption_demo_01 -n 4 -l info -flatten False --omit_image_file False --caption_output_type parquet
