...
output_file_path_template = "/home/horton/datasets/meta-scir/dataset-title-section/{}.parquet"
...
for spilt in splits:
    ...
    df["caption"] = df.apply(lambda row: f"{row['article_title']} {row['concepts']} {row['new_section']} {row['caption']}", axis=1)
    print(df.head())
